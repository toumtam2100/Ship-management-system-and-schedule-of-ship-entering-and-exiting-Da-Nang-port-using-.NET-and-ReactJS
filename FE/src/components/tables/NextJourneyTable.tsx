...
const NextJourneyTable: React.FC = () => {
...
// console.log('Combined data:', combinedArrivalsAndDepartures);
  ...
  const columns: TableColumnsType<any> = [
    {
      ...
      render: (text) => (
        <a>
      {text ?    <ItemTableText text={text} />:null}
        </a>
      ),
    ...
    },
    {
      ...
      render: (text) => (
        <a>
        {text ? <ItemTableText text={formatTimestamp(text)} /> : null}
      </a>
      ),
    },
    {
  ...
  return (
    <>
      <Title style={titleStyle}>{`Các đơn được duyệt chưa khởi hành`}</Title>
...
export default NextJourneyTable;
