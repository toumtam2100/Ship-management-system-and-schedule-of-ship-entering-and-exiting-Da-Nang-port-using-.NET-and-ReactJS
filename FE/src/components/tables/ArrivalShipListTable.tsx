...
import { Dropdown, Input, Space, Table, Tag, Typography } from 'antd';
...
const ArrivalShipListTable: React.FC = () => {
  ...
  const columns: TableColumnsType<any> = [
    ...
    {
      title: 'THỜI GIAN VÀO CẢNG',
      dataIndex: 'arrivalTime',
      key: 'departureDateTime',
      align: 'center',
      render: (text) => (
        <a>
          <ItemTableText text={formatTimestamp(text)} />
        </a>
      ),
    },
    {
  ...
  const handleViewShipDetail = (record: any) => {
    navigate(`/approve-arrival-ship-detail/${record.arrivalId}`);
  };
  ...
  return (
    <>
      <Title style={titleStyle}>{`Danh sách tàu vào cảng chờ ${
...
export default ArrivalShipListTable;
